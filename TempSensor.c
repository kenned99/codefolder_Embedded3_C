 ...
 * Compile this example with: gcc -li2c i2c_MCP9808-example1.c -o i2c_MgcCP9808-example1
   
   Compile this example with: 
        gcc -li2c TempSensor.c -o TempSensor
        ./TempSensor
 */
#include <stdio.h>
#include <unistd.h>
...
int main( void ) {
        ...
        if ( reg16poi[0] != 0x5400 ) { // Check manufactorer ID - Big endian 5400 and not 0054
